...
import org.defascat.magnolia.config.DemoBlossomModuleConfiguration;
import org.defascat.magnolia.config.BlossomServletConfiguration;

/**
 * This class manages the lifecycle of the demo-blossom-module module. It starts and stops Spring when Magnolia starts up and
 ...
 */
public class DemoBlossomModule extends BlossomModuleSupport implements ModuleLifecycle {

    public void start(ModuleLifecycleContext moduleLifecycleContext) {
        if (moduleLifecycleContext.getPhase() == ModuleLifecycleContext.PHASE_SYSTEM_STARTUP) {

            // Using Spring java config
            super.initRootWebApplicationContext(DemoBlossomModuleConfiguration.class);
